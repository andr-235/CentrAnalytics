...
@Entity
@Table(
        name = "vk_wall_post_snapshot",
        uniqueConstraints = @UniqueConstraint(name = "uk_vk_wall_post_snapshot_owner_post", columnNames = {"owner_id", "post_id"})
)
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class VkWallPostSnapshot {
