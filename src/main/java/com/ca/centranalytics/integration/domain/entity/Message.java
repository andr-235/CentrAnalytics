...
@Table(
        name = "message",
        uniqueConstraints = @UniqueConstraint(name = "uk_message_conversation_external", columnNames = {"conversation_id", "external_message_id"})
)
@Getter
@Setter
@NoArgsConstructor
...
public class Message {
    ...
    private ProcessingStatus ingestionStatus;
